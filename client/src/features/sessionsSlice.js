...
export const postSession = createAsyncThunk("sessions/postSession", ({ name, password }) => {
    return fetch("/login", {
        method: "POST",
...
export const postSignup = createAsyncThunk("sessions/postSignup", ({ name, password }) => {
    return fetch("/signup", {
        method: "POST",
        headers: {"Content-Type": "application/json"},
        body: JSON.stringify({ name, password })})
